...
export const supabaseSource: DataSource = {
  ...
  getActivity: notWired("getActivity"),
  getFriends: notWired("getFriends"),
  getFriend: notWired("getFriend"),
  getFriendRequests: notWired("getFriendRequests"),
  getFriendQuests: notWired("getFriendQuests"),
  getFriendQuest: notWired("getFriendQuest"),
  getChallenges: notWired("getChallenges"),
