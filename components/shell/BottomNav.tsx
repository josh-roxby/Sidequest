 ...
 *  --primary.
 *
 *  Sizing is intentionally compact: 28px icon container, 14px icon,
 *  tight 6px padding. The pill itself sits 8px from the screen edges. */
export function BottomNav() {
  ...
  return (
    <nav
      aria-label="Primary"
      className="fixed inset-x-4 bottom-2 z-40 flex items-center justify-between rounded-full border border-border bg-[rgba(255,255,255,0.92)] px-1.5 py-1.5 shadow-lifted backdrop-blur-[14px]"
